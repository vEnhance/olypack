...
for n, day in chosen_problems.items():
	# Make problems
	problems_filename = "problems-day%d.pdf" % n
	...
	subprocess.call(["qpdf",
		...
		'--', problems_tmp_path, problems_enc_path])
